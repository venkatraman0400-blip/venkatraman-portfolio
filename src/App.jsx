      ...
      <section id="connect" style={{ background: 'var(--black)', textAlign: 'center', padding: '6rem 5%' }}>
        <div className="fade-up" style={{ maxWidth: 680, margin: '0 auto' }}>
          ...
          <div className="fade-up cta-row" style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '3rem' }}>
            ...
            <a href="/venkatraman-portfolio/venkatraman_0400_resume.pdf""" target="_blank" rel="noreferrer" className="btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              ⊙ View
            </a>
            <a href="/venkatraman-portfolio/venkatraman_0400_resume.pdf""" download className="btn-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
              ↓ Resume
            </a>
          </div>
